...
public:
	...
	void save_state( vrc6_sound_state_t* ) const;
	void load_state( vrc6_sound_state_t const& );
...
BOOST_STATIC_ASSERT( sizeof (vrc6_sound_state_t) == 20 );
